...
from ansible_collections.purestorage.flasharray.plugins.modules.purefa_phonehome import (
    main,
)
...
class TestMain:
    ...
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_phonehome.get_array"
    )
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_phonehome.AnsibleModule"
    )
    ...
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_phonehome.check_response"
    )
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_phonehome.LooseVersion"
    )
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_phonehome.get_array"
    )
