...
Tests for File System Policy management functions
"""
...
class TestDeletePolicy:
    ...
    @patch("plugins.modules.purefa_policy.LooseVersion")
    def test_delete_policy_check_mode(self, mock_loose_version):
