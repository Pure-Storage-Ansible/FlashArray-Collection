...
class TestDeleteDns:
    ...
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns.get_with_context"
    )
...
class TestDeleteDnsExtended:
    ...
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns.check_response"
    )
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns.get_with_context"
    )
...
class TestMain:
    ...
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns.AnsibleModule"
    )
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns.get_array"
    )
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns.LooseVersion"
    )
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns.update_multi_dns"
    )
    ...
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns.create_multi_dns"
    )
    ...
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns.delete_multi_dns"
    )
    ...
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns._get_source"
    )
    ...
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns.delete_dns"
    )
    ...
    @patch(
        "ansible_collections.purestorage.flasharray.plugins.modules.purefa_dns.create_dns"
    )
