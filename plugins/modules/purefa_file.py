...
def _check_dirs(module, array):
    source_res = array.get_directories(names=[module.params["source_dir"]])
    check_response(
        source_res,
        module,
        f"Source directory {module.params['source_dir']} does not exist",
    )
    target_res = array.get_directories(names=[module.params["target_dir"]])
    check_response(
        target_res,
        module,
        f"Target directory {module.params['target_dir']} does not exist",
    )
...
def main():
    ...
    if not module.check_mode:
        ...
        check_response(res, module, "Failed to copy file")
